...
namespace Electric.DAL
{
	...
	public partial class SYS_User
	{
		...
		public int Add(Electric.Model.SYS_User model)
		{
			...
			strSql.Append("Code,Name,Pwd,IsAdmin,RowStatus,CreateUserID,CreateTime,UpdateUserID,UpdateTime)");
			...
			parameters[4].Value = model.RowStatus;
		...
		public Electric.Model.SYS_User GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,Code,Name,Pwd,IsAdmin,RowStatus,CreateUserID,CreateTime,UpdateUserID,UpdateTime from SYS_User ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,Code,Name,Pwd,IsAdmin,RowStatus,CreateUserID,CreateTime,UpdateUserID,UpdateTime ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,Code,Name,Pwd,IsAdmin,RowStatus,CreateUserID,CreateTime,UpdateUserID,UpdateTime ");
			strSql.Append(" FROM SYS_User ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
