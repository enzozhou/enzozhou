    ...
    public partial class BS_PurchaseContract
    {
        ...
        public int Add(Electric.Model.BS_PurchaseContract model)
        {
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@BearCost",SqlDbType.NVarChar,100) };
            ...
            parameters[28].Value = model.BearCost;
        ...
        public bool Update(Electric.Model.BS_PurchaseContract model)
        {
            ...
            strSql.Append("BearCost=@BearCost");
            ...
            parameters[29].Value = model.BearCost;
        ...
        public Electric.Model.BS_PurchaseContract GetModel(int ID)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds.Tables[0].Rows[0]["BearCost"] != null && ds.Tables[0].Rows[0]["BearCost"].ToString() != "")
                {
                    model.BearCost = ds.Tables[0].Rows[0]["BearCost"].ToString();
                }
                return model;
            }
            else
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,OrgCode,ContractNo,PartnerCode,PartnerName,PartnerAddress,PartnerContract,PartnerTel,PartnerBank,PartnerAccount,PartnerTaxNo,DeliveryTime,Price,Words,FPP,FPR,SPR,CheckedLimit,LPP,LPR,DamagesRate,CreateUserID,CreateTime,UpdateUserID,UpdateTime,SubmitUserID,SubmitTime,ApproveUserID,ApproveTime,BearCost ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,OrgCode,ContractNo,PartnerCode,PartnerName,PartnerAddress,PartnerContract,PartnerTel,PartnerBank,PartnerAccount,PartnerTaxNo,DeliveryTime,Price,Words,FPP,FPR,SPR,CheckedLimit,LPP,LPR,DamagesRate,CreateUserID,CreateTime,UpdateUserID,UpdateTime,SubmitUserID,SubmitTime,ApproveUserID,ApproveTime,BearCost ");
            strSql.Append(" FROM BS_PurchaseContract ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
