...
namespace Electric.DAL
{
    ...
    public partial class BS_NewForOld_Details
    {
        ...
        public int Add(Electric.Model.BS_NewForOld_Details model)
        {
            ...
            strSql.Append("OrgCode,ContractNo,OldModel,OldPowerRating,OldQty,OldSpeed,OldProtectionLev,OldOutDate,OldPE,OldWeight,OldPrice,OldSubsidy,OldSumPrice,TerminalUnit,TUNo,NewModel,NewPowerRating,NewQty,PurchasePrice,Reconstruction,NewInvoiceNo,NewInvoiceDate,NewMC,NewSerialNum,CreateUserID,CreateTime,UpdateUserID,UpdateTime,SubmitUserID,SubmitTime,ApproveUserID,ApproveTime,OldUnitPrice)");
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@OldPE",SqlDbType.NVarChar,100), 
                    ...
                    new SqlParameter("@OldUnitPrice",SqlDbType.Decimal,9)};
            ...
            parameters[8].Value = model.OldPE;
            parameters[9].Value = model.OldWeight;
            parameters[10].Value = model.OldPrice;
            parameters[11].Value = model.OldSubsidy;
            parameters[12].Value = model.OldSumPrice;
            parameters[13].Value = model.TerminalUnit;
            parameters[14].Value = model.TUNo;
            parameters[15].Value = model.NewModel;
            parameters[16].Value = model.NewPowerRating;
            parameters[17].Value = model.NewQty;
            parameters[18].Value = model.PurchasePrice;
            parameters[19].Value = model.Reconstruction;
            parameters[20].Value = model.NewInvoiceNo;
            parameters[21].Value = model.NewInvoiceDate;
            parameters[22].Value = model.NewMC;
            parameters[23].Value = model.NewSerialNum;
            ...
            parameters[28].Value = model.SubmitUserID;
            parameters[29].Value = model.SubmitTime;
            parameters[30].Value = model.ApproveUserID;
            parameters[31].Value = model.ApproveTime;
            parameters[32].Value = model.OldUnitPrice;
        ...
        public bool Update(Electric.Model.BS_NewForOld_Details model)
        {
            ...
            strSql.Append("OldUnitPrice=@OldUnitPrice");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@OrgCode", SqlDbType.NVarChar,50),
					new SqlParameter("@ContractNo", SqlDbType.NVarChar,50),
        ...
        public Electric.Model.BS_NewForOld_Details GetModel(int ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,OrgCode,ContractNo,OldModel,OldPowerRating,OldQty,OldSpeed,OldProtectionLev,OldOutDate,OldPE,OldWeight,OldPrice,OldSubsidy,OldSumPrice,TerminalUnit,TUNo,NewModel,NewPowerRating,NewQty,PurchasePrice,Reconstruction,NewInvoiceNo,NewInvoiceDate,NewMC,NewSerialNum,CreateUserID,CreateTime,UpdateUserID,UpdateTime,SubmitUserID,SubmitTime,ApproveUserID,ApproveTime,OldUnitPrice from BS_NewForOld_Details ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds.Tables[0].Rows[0]["OldPE"] != null && ds.Tables[0].Rows[0]["OldPE"].ToString() != "")
                {
                    model.OldModel = ds.Tables[0].Rows[0]["OldPE"].ToString();
                }
                ...
                if (ds.Tables[0].Rows[0]["OldUnitPrice"] != null && ds.Tables[0].Rows[0]["OldUnitPrice"].ToString() != "")
                {
                    model.OldSpeed = decimal.Parse(ds.Tables[0].Rows[0]["OldUnitPrice"].ToString());
                }
                return model;
            }
            else
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,OrgCode,ContractNo,OldModel,OldPowerRating,OldQty,OldSpeed,OldProtectionLev,OldOutDate,OldPE,OldWeight,OldPrice,OldSubsidy,OldSumPrice,TerminalUnit,TUNo,NewModel,NewPowerRating,NewQty,PurchasePrice,Reconstruction,NewInvoiceNo,NewInvoiceDate,NewMC,NewSerialNum,CreateUserID,CreateTime,UpdateUserID,UpdateTime,SubmitUserID,SubmitTime,ApproveUserID,ApproveTime,OldUnitPrice ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,OrgCode,ContractNo,OldModel,OldPowerRating,OldQty,OldSpeed,OldProtectionLev,OldOutDate,OldPE,OldWeight,OldPrice,OldSubsidy,OldSumPrice,TerminalUnit,TUNo,NewModel,NewPowerRating,NewQty,PurchasePrice,Reconstruction,NewInvoiceNo,NewInvoiceDate,NewMC,NewSerialNum,CreateUserID,CreateTime,UpdateUserID,UpdateTime,SubmitUserID,SubmitTime,ApproveUserID,ApproveTime,OldUnitPrice ");
            strSql.Append(" FROM BS_NewForOld_Details ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
