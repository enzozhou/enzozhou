...
{
	/// <summary>
	/// 数据访问类:BS_PurchaseContract_Details
	/// </summary>
	public partial class BS_PurchaseContract_Details
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "BS_PurchaseContract_Details"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from BS_PurchaseContract_Details");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Electric.Model.BS_PurchaseContract_Details model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BS_PurchaseContract_Details(");
			strSql.Append("OrgCode,ContractNo,Model,Qty,PowerRating,UnitPrice,Price,Subsidy,SumPrice,CreateUserID,CreateTime,UpdateUserID,UpdateTime)");
			...
			parameters[4].Value = model.PowerRating;
			parameters[5].Value = model.UnitPrice;
			parameters[6].Value = model.Price;
			parameters[7].Value = model.Subsidy;
			parameters[8].Value = model.SumPrice;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Electric.Model.BS_PurchaseContract_Details model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BS_PurchaseContract_Details set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BS_PurchaseContract_Details ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Electric.Model.BS_PurchaseContract_Details GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,OrgCode,ContractNo,Model,Qty,PowerRating,UnitPrice,Price,Subsidy,SumPrice,CreateUserID,CreateTime,UpdateUserID,UpdateTime from BS_PurchaseContract_Details ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
			...
			Electric.Model.BS_PurchaseContract_Details model=new Electric.Model.BS_PurchaseContract_Details();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,OrgCode,ContractNo,Model,Qty,PowerRating,UnitPrice,Price,Subsidy,SumPrice,CreateUserID,CreateTime,UpdateUserID,UpdateTime ");
			strSql.Append(" FROM BS_PurchaseContract_Details ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,OrgCode,ContractNo,Model,Qty,PowerRating,UnitPrice,Price,Subsidy,SumPrice,CreateUserID,CreateTime,UpdateUserID,UpdateTime ");
			strSql.Append(" FROM BS_PurchaseContract_Details ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from BS_PurchaseContract_Details T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BS_PurchaseContract_Details";
