...
{
	/// <summary>
	/// BS_NewForOld:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class BS_NewForOld
	{
		...
		private int? _totaloldqty;
		private decimal? _totalpowerrating;
		private decimal? _totaloldprice;
		private decimal? _totaloldsubsidy;
		private decimal? _totaloldsumprice;
		...
		/// 
		/// </summary>
		public int? TotalOldQty
		{
			set{ _totaloldqty=value;}
			get{return _totaloldqty;}
		}
		/// <summary>
		/// 
		/// </summary>
		public decimal? TotalPowerRating
		{
			set{ _totalpowerrating=value;}
			get{return _totalpowerrating;}
		}
		/// <summary>
		/// 
		/// </summary>
		public decimal? TotalOldPrice
		{
			set{ _totaloldprice=value;}
			get{return _totaloldprice;}
		}
		/// <summary>
		/// 
		/// </summary>
		public decimal? TotalOldSubsidy
		{
			set{ _totaloldsubsidy=value;}
			get{return _totaloldsubsidy;}
		}
		/// <summary>
		/// 
		/// </summary>
		public decimal? TotalOldSumPrice
		{
			set{ _totaloldsumprice=value;}
			get{return _totaloldsumprice;}
		}
		/// <summary>
		/// 
		/// </summary>
