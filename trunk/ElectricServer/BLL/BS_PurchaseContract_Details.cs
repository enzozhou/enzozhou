...
{
	/// <summary>
	/// BS_PurchaseContract_Details
	/// </summary>
	public partial class BS_PurchaseContract_Details
	{
		private readonly Electric.DAL.BS_PurchaseContract_Details dal=new Electric.DAL.BS_PurchaseContract_Details();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Electric.Model.BS_PurchaseContract_Details GetModelByCache(int ID)
		{
			
			string CacheKey = "BS_PurchaseContract_DetailsModel-" + ID;
			...
			return (Electric.Model.BS_PurchaseContract_Details)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Electric.Model.BS_PurchaseContract_Details> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Electric.Model.BS_PurchaseContract_Details> DataTableToList(DataTable dt)
		{
			List<Electric.Model.BS_PurchaseContract_Details> modelList = new List<Electric.Model.BS_PurchaseContract_Details>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Electric.Model.BS_PurchaseContract_Details model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Electric.Model.BS_PurchaseContract_Details();
