...
namespace Electric.BLL
{
	...
	{
		private readonly Electric.DAL.BAS_Employess dal=new Electric.DAL.BAS_Employess();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(Electric.Model.BAS_Employess model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Electric.Model.BAS_Employess model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public Electric.Model.BAS_Employess GetModel(int ID)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Electric.Model.BAS_Employess GetModelByCache(int ID)
		{
			
			string CacheKey = "BAS_EmployessModel-" + ID;
			...
			return (Electric.Model.BAS_Employess)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Electric.Model.BAS_Employess> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Electric.Model.BAS_Employess> DataTableToList(DataTable dt)
		{
			List<Electric.Model.BAS_Employess> modelList = new List<Electric.Model.BAS_Employess>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Electric.Model.BAS_Employess model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Electric.Model.BAS_Employess();
