...
Namespace BusinessObject
    <CXDBTableWithSP(TableName:="[dbo].[Rolepermission]",SelectFromClause:="[dbo].[Rolepermission] ",InsertStoredProcedure:="stp_I_clsRolepermission",SelectStoredProcedure:="stp_S_clsRolepermission",DeleteStoredProcedure:="stp_D_clsRolepermission",UpdateStoredProcedure:="stp_U_clsRolepermission"), Serializable()> _
Public MustInherit Class clsRolepermissionBase_
...
#Region "Properties"
        ...
        <CXDBField(DBFieldName:="role_code", DataType:=12, Size:=10, Flags:=CType(18, CXDBFieldFlags), SPUpdateOrdinal:=0, SPKeyOrdinal:=0), BusinessProperty("ID_cap_clsRolepermission_role_code")> _
        ...
        <CXDBField(DBFieldName:="right_no", DataType:=12, Size:=20, Flags:=CType(18, CXDBFieldFlags), SPUpdateOrdinal:=1, SPKeyOrdinal:=1), BusinessProperty("ID_cap_clsRolepermission_right_no")> _
        ...
        <CXDBField(DBFieldName:="remark", DataType:=11, SPUpdateOrdinal:=2), BusinessProperty("ID_cap_clsRolepermission_remark"), NullValue("")> _
        ...
        <CXDBField(DBFieldName:="opt_by", DataType:=12, Size:=20, SPUpdateOrdinal:=3), BusinessProperty("ID_cap_clsRolepermission_opt_by"), NullValue("")> _
        ...
        Public Overridable Property opt_dtimeText() As System.String
            ...
            End Set
        End Property
        <CXDBField(DBFieldName:="opt_dtime", DataType:=4, Size:=8, SPUpdateOrdinal:=4), BusinessProperty("ID_cap_clsRolepermission_opt_dtime"), IsDateType(), System.ComponentModel.Editor(GetType(COMExpress.BusinessObject.Design.CXSmartDateEditor), GetType(System.Drawing.Design.UITypeEditor))> _
        Public Overridable Property opt_dtime() As Object
            ...
            End Set
        End Property
		<CXDBField(DBFieldName:="opt_timestamp", DataType:=19, Size:=30, Flags:=CType(100, CXDBFieldFlags), SPUpdateOrdinal:=5), BusinessProperty("ID_cap_clsRolepermission_opt_timestamp")> _
	    ...
	    Public Overrides ReadOnly Property BusinessCollectionType() As Type
	    	Get
	    	    Return GetType(clsRolepermissions)
	    	End Get
		End Property
...
#Region " Shared Methods "    	
    	Public Shared Function Fetch(ByVal vrole_code As System.String, ByVal vright_no As System.String, Optional ByVal nLevel As Integer = 0) As clsRolepermission
    	    Return CType(DataPortal.Fetch(New Criteria(GetType(clsRolepermission), nLevel, "role_code", vrole_code, "right_no", vright_no)), clsRolepermission)
    	End Function  	
    	Public Shared Function Load(ByVal vrole_code As System.String, ByVal vright_no As System.String, Optional ByVal nLevel As Integer = 0) As clsRolepermission
    	    Return CType(DataPortal.Fetch(New Criteria(GetType(clsRolepermission), nLevel, "role_code", vrole_code, "right_no", vright_no)), clsRolepermission)
    	End Function
    	
    	Public Shared Function LoadList(ByVal _Filters As CXFilters, Optional ByVal nLevel As Integer = 0, Optional ByVal iMaxNumber As Integer = 0) As clsRolepermissions
    	    Return YT.BusinessObject.clsRolepermissions.Fetch(_Filters, nLevel, iMaxNumber)
    	End Function
    	
    	Public Shared Function LoadListFromObj(ByVal obj As clsRolepermission, Optional ByVal nLevel As Integer = 0) As clsRolepermissions
    	    Return YT.BusinessObject.clsRolepermissions.Fetch(obj, nLevel)
    	End Function
    	    	
    	Public OverLoads Shared Sub Delete(ByVal vrole_code As System.String, ByVal vright_no As System.String, Optional ByVal nLevel As Integer = 0)
    	    DataPortal.Delete(New Criteria(GetType(clsRolepermission), nLevel, "role_code", vrole_code, "right_no", vright_no))
    	End Sub
    	
    	Public Shared Function NewclsRolepermission() As clsRolepermission
            Return CType(DataPortal.Create(New Criteria(GetType(clsRolepermission), 0)), clsRolepermission)
        End Function
        
        Public Shared Function LoadListByWhereSQL(ByVal strWhereClause As String, Optional ByVal nLevel As Integer = 0, Optional ByVal iMaxNumber As Integer = 0) As clsRolepermissions
            Return YT.BusinessObject.clsRolepermissions.Fetch(strWhereClause , nLevel, iMaxNumber)
        End Function
#End Region
...
#Region " Your custom code section{67DE6B32-F9AE-4b19-B6B8-26FE2B6985D4}"    
    <Serializable()> Public Class clsRolepermission
        Inherits clsRolepermissionBase_
