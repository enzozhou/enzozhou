...
Namespace Security
    ...
    <Serializable()> _
    Public Class ImpBusinessPrincipal
        Implements IPrincipal

        Private mIdentity As ImpBusinessIdentity
...
#Region " Login process "
        ...
        Public Shared Sub Login(ByVal Username As String, ByVal Password As String)
            Dim p As New ImpBusinessPrincipal(Username, Password)
        End Sub
        ...
        Private Sub New(ByVal Username As String, ByVal Password As String)
            ...
            Try
                If Not TypeOf OldPrincipal Is ImpBusinessPrincipal Then
            ...
            mIdentity = ImpBusinessIdentity.LoadIdentity(Username, Password)
