...
Public Class clsOptimizationDN
    Public Function CreateBanchBySingleDN(ByVal dc_code As String, ByVal sony_bch_no As String, ByVal bch_no As String, ByVal dn_no As String, ByRef RetCode As String, ByRef RetMsg As String) As Boolean
        ...
        Try
            ...
            cmd.CommandText = "APP_Create_Banch"
        ...
        Catch eex As Exception
            ...
            Catch ee As Exception
                ErrorMsg(eex, Me.GetType, "Create Banch")
                Return False
            End Try
            Return False
        Finally
        ...
        End Try
    End Function
    Public Function OptimizationBanch(ByVal dc_code As String, ByVal bch_no As String, ByRef RetCode As String, ByRef RetMsg As String) As Boolean
        Dim cmd As IDbCommand = COMExpress.BusinessObject.DatabaseHelper.CreateDbCommand
        Dim parmUserCode As String = UserRightMgr.gUserCode
        Dim prm1 As IDbDataParameter = COMExpress.BusinessObject.DatabaseHelper.CreateDbParameter
        Dim prm3 As IDbDataParameter = COMExpress.BusinessObject.DatabaseHelper.CreateDbParameter
        ...
        Try
            ...
            cmd.Parameters.Add(prm7)
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = "APP_Optimization_Banch"
            DatabaseHelper.OpenConnection(cmd.Connection)
            If Not DatabaseHelper.InGlobalTransaction Then cmd.Transaction = cmd.Connection.BeginTransaction(COMExpress.BusinessObject.DatabaseHelper.TransIsolationLevel)
            cmd.ExecuteNonQuery()
            If Not DatabaseHelper.InGlobalTransaction Then cmd.Transaction.Commit()
            Return True
        Catch eex As Exception
            ErrMsg("»õÎ»ÍÆ¼ö´íÎó", True, prm7.Value)
            If Not DatabaseHelper.InGlobalTransaction Then cmd.Transaction.Commit()
            'Try
            '    ErrorMsg(eex, Me.GetType, "Optimization Banch")
            '    If Not DatabaseHelper.InGlobalTransaction Then cmd.Transaction.Rollback()
            'Catch ee As Exception
            '    ErrorMsg(ee, Me.GetType, "Optimization Banch")
            '    Return False
            'End Try
            'Return False
        Finally
        ...
        End Try
    End Function
    Public Function CreateTaskByBanch(ByVal dc_code As String, ByVal TaskNo As String, ByVal BanchNo As String, ByVal usercode As String, ByRef RetCode As String, ByRef RetMsg As String) As Boolean
        Dim cmd As IDbCommand = COMExpress.BusinessObject.DatabaseHelper.CreateDbCommand
        Dim parmUserCode As String = UserRightMgr.gUserCode
        Dim prm1 As IDbDataParameter = COMExpress.BusinessObject.DatabaseHelper.CreateDbParameter
        Dim prm2 As IDbDataParameter = COMExpress.BusinessObject.DatabaseHelper.CreateDbParameter
        ...
        Try
            ...
            cmd.Parameters.Add(prm7)
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = "APP_Create_Task"
            DatabaseHelper.OpenConnection(cmd.Connection)
            If Not DatabaseHelper.InGlobalTransaction Then cmd.Transaction = cmd.Connection.BeginTransaction(COMExpress.BusinessObject.DatabaseHelper.TransIsolationLevel)
            cmd.ExecuteNonQuery()
            If Not DatabaseHelper.InGlobalTransaction Then cmd.Transaction.Commit()
        ...
        Catch eex As Exception
            Try
                If Not DatabaseHelper.InGlobalTransaction Then cmd.Transaction.Rollback()
            Catch ee As Exception
                ErrorMsg(eex, Me.GetType, "APP_Create_Taskh")
                Return False
            End Try
            Return False
        Finally
        ...
        End Try
    End Function
    Public Function OptimizationBySingleDN(ByVal dc_code As String, ByVal dn_no As String, ByRef RetCode As String, ByRef RetMsg As String) As Boolean
        Dim cmd As IDbCommand = COMExpress.BusinessObject.DatabaseHelper.CreateDbCommand
        Dim parmUserCode As String = UserRightMgr.gUserCode
        Dim prm1 As IDbDataParameter = COMExpress.BusinessObject.DatabaseHelper.CreateDbParameter
        Dim prm2 As IDbDataParameter = COMExpress.BusinessObject.DatabaseHelper.CreateDbParameter
        ...
        Try
            ...
            cmd.Parameters.Add(prm5)
            cmd.CommandType = CommandType.StoredProcedure
            cmd.CommandText = "APP_Optimization_DN_WithOutBanch"
            DatabaseHelper.OpenConnection(cmd.Connection)
            If Not DatabaseHelper.InGlobalTransaction Then cmd.Transaction = cmd.Connection.BeginTransaction(COMExpress.BusinessObject.DatabaseHelper.TransIsolationLevel)
            cmd.ExecuteNonQuery()
            If Not DatabaseHelper.InGlobalTransaction Then cmd.Transaction.Commit()
        ...
        Catch eex As Exception
            Try
                If Not DatabaseHelper.InGlobalTransaction Then cmd.Transaction.Rollback()
            Catch ee As Exception
                ErrorMsg(eex, Me.GetType, "APP_Optimization_DN_WithOutBanch")
                Return False
            End Try
            Return False
        Finally
