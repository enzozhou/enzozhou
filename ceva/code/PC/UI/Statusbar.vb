...
Public Class StatusbarService
    ...
    Public Sub Status(Optional ByVal Msg As String = "Ready", Optional ByVal PanelIndex As Integer = 0) Implements COMExpress.Windows.Forms.IStatusBarService.Status
        If Msg = "Ready" Then
            Msg = PublicResource.LoadResString("ID_cap_StatusBar_Ready", "Ready")
        End If
    ...
    Public Sub RefreshStatus() Implements COMExpress.Windows.Forms.IStatusBarService.RefreshStatus
        mobjSB.Refresh()
    End Sub
